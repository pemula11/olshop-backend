        ...
        <div class="card-body card-black">
            <form action="{{route('products.update', $item->id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="type" id="" value="{{old('type') ? old('type') : $item->type}}" class="form-control @error('type') is-invalid @enderror">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" id="" value="{{old('price') ? old('price') : $item->price}}" class="form-control @error('price') is-invalid @enderror">
