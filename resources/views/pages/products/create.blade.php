        ...
        <div class="card-body card-black">
            <form action="{{route('products.store')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="type" id="" value="{{old('type')}}" class="form-control @error('type') is-invalid @enderror">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" id="" value="{{old('price')}}" class="form-control @error('price') is-invalid @enderror">
